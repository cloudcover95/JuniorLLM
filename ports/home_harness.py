...
BIND = {"hook": "127.0.0.1:8770", "ui": "127.0.0.1:8771", "i2sd": "127.0.0.1:8767"}
...
if __name__ == "__main__":
    import json
    print(json.dumps(harness("field flagstaff"), indent=2))
    print(json.dumps(harness("ue5 spark", 90), indent=2))
