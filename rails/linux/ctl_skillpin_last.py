"""T22 — skill-pin last. Loopback only. Never fetch. Never exec."""
...
def skill_pin_last(root: str | None = None) -> dict:
    """T22 — report last SKILL_PINS.jsonl row under a root. Never body. Never fetch. Never exec."""
    ...
    return {
        ...
        "count": 1 if last is not None else 0,
        "total": len(rows),
